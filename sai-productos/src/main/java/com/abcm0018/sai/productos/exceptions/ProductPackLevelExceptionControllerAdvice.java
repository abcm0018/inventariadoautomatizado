...
public class ProductPackLevelExceptionControllerAdvice {
    ...
    @ExceptionHandler(ProductPackLevelServiceException.class)
    public ResponseEntity<StandardResponse<Object>> handleProductException(ProductPackLevelServiceException ex){
