...
/**
 * DTO de respuesta detallado para Product (GET by ID)
 * Incluye información completa y cálculos de negocio
 */
@Data
@Builder
@NoArgsConstructor
...
public class ProductDetailResponseDTO implements Serializable {
	...
	@JsonProperty("is_valid_for_inventory")
	private boolean isValidForInventory;
