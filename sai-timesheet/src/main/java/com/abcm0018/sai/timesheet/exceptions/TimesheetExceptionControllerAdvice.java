package com.abcm0018.sai.timesheet.exceptions;
...
public class TimesheetExceptionControllerAdvice {
    ...
    @ExceptionHandler(TimesheetServiceException.class)
    public ResponseEntity<StandardResponse<Object>> handleShiftException(TimesheetServiceException ex){
