...
public class UserServiceImpl implements UserService {
	...
	public UserStatisticsDTO getGlobalStatistics() {
		...
		// Estadísticas de actividad (cross-domain — delegadas a fachada en sai-app)
		Long usersWithWorkshifts = 0L;
		Long usersWhoScannedPalets = 0L;
	...
	private void validateCanPermanentlyDelete(User user) {
		// Cross-domain validation (workshifts, palets) delegated to facade in sai-app
	}
