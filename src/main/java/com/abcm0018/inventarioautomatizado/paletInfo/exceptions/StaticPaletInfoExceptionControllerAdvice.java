...
@Order(121)
@Slf4j
public class StaticPaletInfoExceptionControllerAdvice {
    ...
    public ResponseEntity<StandardResponse<Object>> handlePaletException(StaticPaletInfoServiceException ex){
        log.error(ex.getMessage(), ex);
